                                ...
                                <a href="#"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            <rect fill="#000000" opacity="0.3"
                                                ...
                                                x="4" y="11" width="16" heightMarquez="2" rx="1" />
                                        </g>
                                    </svg></a>
                                <div>
                        ...
                        <ul class="navbar-nav header-right main-notification">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src={{ asset('storage/' . auth()->user()->avatar) }} width="20"
                                        alt="" />
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <div class="main-profile">
                    ...
                    <h5 class="mb-0 fs-20 text-black "><span class="font-w400">Hello </span>
                        {{ auth()->user()->name }}</h5>
                ...
                <ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href={{ route('plans.show') }}>Plans</a></li>
                            <li><a href={{ route('users.show') }}>Users Info</a></li>
                            <li><a href={{ route('contacts.show') }}>Contacts Details</a></li>
                        </ul>
